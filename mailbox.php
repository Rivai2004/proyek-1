...
<head>
  ...
  <title>AdminLTE 3 | Aduan Warga</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Inbox Aduan Warga</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Inbox Aduan Warga</li>
              </ol>
            </div>
          </div>
        </div>
                ...
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item active">
                    <a href="#" class="nav-link">
                      <i class="fas fa-inbox"></i> Inbox Aduan Warga
                          ...
                          <tr>
                            <td>
                              <div class="icheck-primary">
                                <input type="checkbox" value="<?php echo $r2['id_aduan']; ?>" id="check<?php echo $urut; ?>" />
                            ...
                            <td class="mailbox-subject">
                              <b><?php echo $email ?></b> - <?php echo $aduan ?>
                            </td>
