...
if ($op == 'delete') {
  $id_kelembagaan = $_GET['id'];
  $sql1 = "delete from kelembagaan where id_kelembagaan= '$id_kelembagaan'";
...
if ($op == 'edit') {
  $id_kelembagaan = $_GET['id'];
  $sqldef = "select * from kelembagaan where id_kelembagaan = '$id_kelembagaan'";
  $q1 = mysqli_query($conn, $sqldef);
  $r1 = mysqli_fetch_array($q1);
  $id_kelembagaan = $r1['id_kelembagaan'];
  $image  = $r1['image'];
  $nama = $r1['nama'];
...
if (isset($_POST['simpan'])) { //untuk create
  ...
  if ($id_kelembagaan && $nama && isset($_FILES['image']['name'])) {
    ...
    if (move_uploaded_file($image_tmp, $folder_tujuan)) {
      if ($op == 'edit') { //untuk update
        $sql1 = "update kelembagaan set image='$image',nama='$nama' where id_kelembagaan = '$id_kelembagaan'";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
        ...
        $sql1 = "insert into kelembagaan(id_kelembagaan,image,nama) values ('$id_kelembagaan','$image','$nama')";
        $q1 = mysqli_query($conn, $sql1);
        if ($q1) {
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="mb-3 row">
                <label for="id_kelembagaan" class="col-sm-2 col-form-label">ID SOTK</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="id_kelembagaan" name="id_kelembagaan" value="<?php echo $id_kelembagaan ?>" required />
                </div>
              </div>
              <div class="mb-3 row">
        ...
        <div class="card">
          <div class="card-header text-white bg-secondary">Data Pengguna</div>
          <div class="card-body">
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td scope="row">
                      <a href="?op=edit&id=<?php echo $id_kelembagaan ?>"><button type="button" class="btn btn-warning">
                          Edit
                        </button></a>
                      <a href="?op=delete&id=<?php echo $id_kelembagaan ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">
                          Delete
                        </button></a>
                    </td>
                  </tr>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2023
        <a href="https://adminlte.io">Desa Leuwigede</a>.</strong>
      All rights reserved.
